...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.25\textwidth]{stationsim_gcs-initialise_agent}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{stationsim_gcs-choose_agent_entrance}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{stationsim_gcs-choose_agent_exit}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{stationsim_gcs-allocate_agent_location}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{stationsim_gcs-check_agent_activation}
