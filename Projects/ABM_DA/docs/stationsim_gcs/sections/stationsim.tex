...
Of the variables detailed for each of the entities in Tables
\ref{tab:agent_variables}, \ref{tab:environment_variables},
\ref{tab:gate_variables} and \ref{tab:obstacle_variables}, the majority are set
