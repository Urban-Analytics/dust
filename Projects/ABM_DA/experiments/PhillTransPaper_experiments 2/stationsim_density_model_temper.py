# -*- coding: utf-8 -*-
"""
edited on Fri Aug 21 10:19:05 2020
...
class Agent:
    ...
    def monte_move(self):
        '''
         Random Monte Carlo step for tempering
...
#        self.location = self.location + (np.random.randint(70, size=self.speed.shape) * rand_direction) #random distance 5m max (70 pixels)
