...
'''
StationSim model with modifications by MK
dated 12 Mar 2020
...
class Agent:
    ...
    def __init__(self, model, unique_id):
        ...
        Desctiption:
            ...
            and desired speed.
            We now assume that there are two classes of agents: those who come 
...
class Model:
    ...
    def __init__(self, unique_id=None, **kwargs):
        ...
        self.bins = np.linspace(0, self.step_limit, self.no_waves+1)+np.random.normal(0,self.train_delay,self.no_waves+1)
