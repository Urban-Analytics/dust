...
def IncreaseRate_analysis():
    ...
    for IncreaseRate in range(1,20,2):
        ...
        if do_plot:
            ...
            plt.legend()
            plt.show()
            name0 = ['/Users/minhlkieu/Dropbox/Minh_UoL/DA/ABM/BusSim/Figures/Fig_calibration_IncreaseRate_',str(IncreaseRate),'.pdf']
            str1 = ''.join(name0)    
    ...
    if do_plot_results:
        ...
        plt.legend()
        plt.show()
        plt.savefig('/Users/minhlkieu/Dropbox/Minh_UoL/DA/ABM/BusSim/Figures/Fig_calibration_results_IncreaseRate.pdf', dpi=200,bbox_inches='tight')
...
def maxDemand_analysis():
    ...
    for maxDemand in range(1,10,2):
        ...
        if do_plot:
            ...
            plt.legend()
            plt.show()
            name0 = ['/Users/minhlkieu/Dropbox/Minh_UoL/DA/ABM/BusSim/Figures/Fig_calibration_maxDemand_',str(maxDemand),'.pdf']
            str1 = ''.join(name0)    
            plt.savefig(str1, dpi=200,bbox_inches='tight')
    ...
    if do_plot_results:
        ...
        plt.legend()
        plt.show()
        plt.savefig('/Users/minhlkieu/Dropbox/Minh_UoL/DA/ABM/BusSim/Figures/Fig_calibration_results_maxDemand.pdf', dpi=200,bbox_inches='tight')
