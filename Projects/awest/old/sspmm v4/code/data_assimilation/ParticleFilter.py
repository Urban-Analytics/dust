...
class ParticleFilter:
    ...
    def __init__(self, model, number_of_particles, particle_std=0, model_std=0, resample_window=10, do_copies=True, do_save=False):
        '''
    ...
    def plot_save(self):
        _, (ax, ax1) = plt.subplots(2)

        ax.plot(self.active)
        ax.set_ylabel('Active agents')

        ax1.plot(self.mean_errors)
